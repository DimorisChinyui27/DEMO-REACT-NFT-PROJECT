...
const SectionWrapper = ({ title, description, showBtn, mockupImg, banner, reverse,second }) => {
  return (
    <div className={`min-h-screen ${styles.section} 
      ...
      <div className={`flex items-center 
        ...
        `}>
          ...
          {showBtn && (
            <Button 
              ...
              link="https://webgl-cars-1-demo.vercel.app/"
              carid={'GT R'}
            />
          )}
          {showBtn && (
        ...
        <div
          className={`flex-1 ${second?styles.flexStart:styles.flexCenter} p-8 sm:px-0`}
        > 
